...
.input-sm{ padding:.45rem .65rem; font-size:.9rem; }  /* compacto */
.btn-sm{ padding:.35rem .6rem; font-size:.85rem; }
.input::placeholder{ font-size:.9rem; color:var(--muted); } /* placeholder pequeño */
...
.form-grid input::placeholder{ color:var(--muted); opacity:1; }
.form-grid select option{ color:var(--text); background:#fff; }
.form-grid input:-webkit-autofill, .form-grid select:-webkit-autofill{
